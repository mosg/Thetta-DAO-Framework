...
global.contract('DaoBaseAuto', (accounts) => {
	...
	global.beforeEach(async() => {
		...
		await aacInstance.setVotingParams("issueTokens", VOTING_TYPE_1P1V, (24 * 60), "Employees", 51, 50, 0);
		await aacInstance.setVotingParams("upgradeDaoContract", VOTING_TYPE_1P1V, (24 * 60), "Employees", 51, 50, 0);
